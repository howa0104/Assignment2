...
public class PostTableView extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            PostLogic cLogic = LogicFactory.getFor("Post");
            List<Post> entities = cLogic.getAll();
            for(Post e : entities){
                   out.printf("<tr><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td></tr>", cLogic.extractDataAsList(e).toArray());
            }
            out.println( "</tr>" );
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Post post = postLogic.updateEntity(request.getParameterMap());
